...
public class RevenueController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        RevenueDAO db = new RevenueDAO();
        ArrayList<ImportPrice> ip = db.getImportPrice();
        ArrayList<ExportPrice> ep = db.getExportPrice();
        
        int revenue = db.exportTotalPrice() - db.importTotalPrice();
